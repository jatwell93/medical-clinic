# Using the API | Australian Bureau of Statistics
...
## Get data[](https://www.abs.gov.au/statistics/application-programming-interfaces-apis/data-api-user-guide/using-api#get-data)
...
-   TIME\_PERIOD: This will return a time series view of the data. This is the default value.
...
## Get metadata[](https://www.abs.gov.au/statistics/application-programming-interfaces-apis/data-api-user-guide/using-api#get-metadata)
...
## Geospatial metadata[](https://www.abs.gov.au/statistics/application-programming-interfaces-apis/data-api-user-guide/using-api#geospatial-metadata)

---
Source: [Using the API](https://www.abs.gov.au/statistics/application-programming-interfaces-apis/data-api-user-guide/using-api)