...
- `.planning/milestones/v1.0-ROADMAP.md` — full phase details, decisions, issues, tech debt
- `.planning/milestones/v1.0-REQUIREMENTS.md` — all 32 requirements marked complete with outcomes
- `.planning/MILESTONES.md` — milestone index with key accomplishments
